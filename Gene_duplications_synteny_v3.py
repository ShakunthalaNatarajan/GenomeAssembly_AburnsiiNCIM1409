...
__usage__=  """
            This script helps in identifying gene duplications in your organism of interest 
            ...
            --org <name of the organism against which pairwise synteny analysis of your desired organism was performed>
            """
######### imports #########
...
#function to obtain the list of gene IDs, that occur twice in the organism that is compared against your desired organism
def twicegenes(input_file,tmp_dir,destination,organism):
    ...
    out_prefile=os.path.join(tmp_dir,"D_purpurea_set2_gene_duplications_with"+organism)
    out_file=os.path.join(destination,"D_purpurea_set2_gene_duplications_with"+"_"+organism+"_"+"no_gene_isoforms")
    ...
    with open (input_file,"r") as f1:
        with open (gr,"w") as out:
            ...
            while line1:
                ...
                line1=f1.readline()            
    """
    to obtain the list of gene IDs that occur twice in the organism that is compared against your organism of interest, 
    as a compiled list containing each of these IDs only once, as we need only gene duplications in the organism of interest and for
    this we need to know the list of those genes in the other organism that occur twice, but must be processed to obtain a list
